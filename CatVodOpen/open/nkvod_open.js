...
let parseMap = {
    '新自建.5': 'https://op.xn--it-if7c19g5s4bps5c.com/player/ez.php?code=nkvod&if=1&url=',
    '新自建': 'https://op.xn--it-if7c19g5s4bps5c.com/player/ez.php?code=nkvod&if=1&url=',
    'Pp自建': 'https://op.xn--it-if7c19g5s4bps5c.com/player/ez.php?code=nkvod&if=1&url=',
    '自建三.5': 'https://op.xn--it-if7c19g5s4bps5c.com/player/ez.php?code=nkvod&if=1&url=',
    '新自建.0': 'https://op.xn--it-if7c19g5s4bps5c.com/player/ez.php?code=nkvod&if=1&url=',
    '自建三': 'https://op.xn--it-if7c19g5s4bps5c.com/player/ez.php?code=nkvod&if=1&url=',
    'Af自建': 'https://op.xn--it-if7c19g5s4bps5c.com/player/ez.php?code=nkvod&if=1&url=',
    '自建四': 'https://op.xn--it-if7c19g5s4bps5c.com/player/ez.php?code=nkvod&if=1&url=',
    '西瓜视频': 'https://op.xn--it-if7c19g5s4bps5c.com/player/xigua.php?code=nkvod&if=1&url=',
    '自建一': 'https://ag.xn--it-if7c19g5s4bps5c.com/nk.php?url=',
    '自建二': 'https://ag.xn--it-if7c19g5s4bps5c.com/nk.php?url=',
    '腾讯视频': 'https://op.xn--it-if7c19g5s4bps5c.com/player/gg.php?code=nkvod&if=1&url=',
    '奇艺视频': 'https://op.xn--it-if7c19g5s4bps5c.com/player/gg.php?code=nkvod&if=1&url=',
    '优酷视频': 'https://op.xn--it-if7c19g5s4bps5c.com/player/gg.php?code=nkvod&if=1&url=',
    '芒果视频': 'https://op.xn--it-if7c19g5s4bps5c.com/player/gg.php?code=nkvod&if=1&url=',
    'B站': 'https://op.xn--it-if7c19g5s4bps5c.com/player/gg.php?code=nkvod&if=1&url=',
    '量子资源': 'https://op.xn--it-if7c19g5s4bps5c.com/player/en.php?code=nkvod&if=1&url=',
    '非凡资源': 'https://op.xn--it-if7c19g5s4bps5c.com/player/en.php?code=nkvod&if=1&url=',
    '失效': 'https://op.xn--it-if7c19g5s4bps5c.com/player/ez.php?code=nkvod&if=1&url=',
    '云播一': 'https://www.lkvod.com/addons/dplayer/?url='
  };
let siteKey = '';
let siteType = 0;
...
async function detail(id) {
    ...
    _.each(tabs, (tab, i) => {
        ...
        _.each(list, (it) => {
            ...
            playMap[from].push(title + '$' + from + '|' +playUrl);
        });
    });
